...
function supabase({ role = 'driver', code = 'GMN0041', application = 'pending', token = 'good' }) {
...
const good = await lib.sign(SECRET, 'win-setup', 'GMN0041', soon);
