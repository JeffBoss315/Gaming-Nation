...
const PORT = Number(process.env.GMN_SMOKE_PORT || 7099);
...
(async () => {
  ...
  await post('/api/fleet/position', {
    id: 'GMN-001', name: 'Test Driver', game: 'ets2', x: 1000, z: 2000,
  ...
  await post('/api/fleet/event', {
    kind: 'job.start', driverId: 'GMN-001', driver: 'Test Driver',
