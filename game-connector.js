...
const CFG = {
  service: flag('service', file.service || process.env.GMN_SERVICE || ''),
  driverId: flag('driver', file.driverId || process.env.GMN_DRIVER || ''),
  name: flag('name', file.name || process.env.GMN_NAME || ''),
  key: flag('key', file.key || process.env.GMN_API_KEY || ''),
